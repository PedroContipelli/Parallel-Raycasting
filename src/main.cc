...
hittable_list scene3() {
	...
	// auto ground_material = make_shared<lambertian>(color(0.05, 0.05, 0.05));
	// world.add(make_shared<sphere>(point3(0,-1000,0), 1000, ground_material));

	auto s1 = make_shared<lambertian>(color(1.0, 1.0, 1.0));
	world.add(make_shared<sphere>(point3(0,0.5,0), 0.5, s1));

	auto s2 = make_shared<lambertian>(color(0.9, 0.9, 0.9));
	world.add(make_shared<sphere>(point3(1,0.5,-1), 0.5, s2));

	auto s3 = make_shared<lambertian>(color(0.8, 0.8, 0.8));
	world.add(make_shared<sphere>(point3(0,0.5,-2), 0.5, s3));

	auto s4 = make_shared<lambertian>(color(0.7, 0.7, 0.7));
	world.add(make_shared<sphere>(point3(-2,0.5,0), 0.5, s4));

	auto s5 = make_shared<lambertian>(color(0.6, 0.6, 0.6));
	world.add(make_shared<sphere>(point3(1,0.5,3), 0.5, s5));

	auto s6 = make_shared<lambertian>(color(0.5, 0.5, 0.5));
	world.add(make_shared<sphere>(point3(6,0.5,-2), 0.5, s6));

	auto s7 = make_shared<lambertian>(color(0.4, 0.4, 0.4));
	world.add(make_shared<sphere>(point3(-2,0.5,-10), 0.5, s7));

	auto s8 = make_shared<lambertian>(color(0.3, 0.3, 0.3));
	world.add(make_shared<sphere>(point3(-15,0.5,3), 0.5, s8));

	auto s9 = make_shared<lambertian>(color(0.2, 0.2, 0.2));
	world.add(make_shared<sphere>(point3(6,0.5,24), 0.5, s9));
